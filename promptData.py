...
prompts = {
    ...
    "extra-time": [
        Prompt("You have some downtime", Task("Study", 0, -5, 10, 0), Task("Watch Netflix", -5, 10, -5, )),
    ...
    "encounter": [
        Prompt("Someone doesn't like your sweater", Task("Fight", -10, 10, -5, -10), Task("Flight", 0, 10, 5, -10)),
